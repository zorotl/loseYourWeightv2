...
<div class="flex flex-col gap-6">
    <x-auth-header :title="__('Melde dich an')" :description="__('Gib deine E-Mail und dein Passwort ein, um dich anzumelden')" />
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        ...
        <div class="flex items-center justify-end">
            <flux:button variant="primary" type="submit" class="w-full">{{ __('Anmelden') }}</flux:button>
        </div>
    </form>
